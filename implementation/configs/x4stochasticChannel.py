...
#######################################################################################
    ...
    # TRAINING
    train(models, train_dataloader, optimizers, coef, MAX_ITER, (fixed_lr, fixed_hr),\
          stochastic={'case':1, 'BATCH_SIZE':BATCH_SIZE, 'LR_PATCH':32, 'LR_VAL_PATCH':128}, MODEL_PATH=PATH, \
          logs=LOGS, device=device, FREEZE_UPSCALE=FREEZE_UPSCALE, cur_iter=CUR_ITER)
